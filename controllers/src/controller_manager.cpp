#include "ros/ros.h"
#include "std_msgs/Float64.h" // For the input publishers
#include "thruster_msgs/ThrustOutput.h" // For the output to hardware_thruster_controller
...
int main(int argc, char **argv){
    ...
    ROS_INFO("Starting high level controller manager");
